...
from .models import CastCrew, Film, FilmCastCrew
...
class FilmDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["director"] = [
            i.cast_crew for i in context["cast_crew"] if i.profession.name == "Director"
        ][0]
        context["actors"] = [
            i.cast_crew for i in context["cast_crew"] if i.profession.name == "Actor"
        ]
        return context
...
class CastCrewDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["films"] = [
            i.film for i in FilmCastCrew.objects.filter(cast_crew=self.object)
        ]
        return context
